...
import {IONIC_DIRECTIVES, Platform, ViewController, NavController, Events, Modal, NavParams} from 'ionic-angular';
...
export class FlexList {
  ...
  addItem() {
    let modal = Modal.create(FlexDetail, { "idForm": this.idForm });
